...
QTextStream& operator>>(QTextStream&, TIME::Duree&); //lecture format hhHmm
...
class Tache
{
 private:
    ...
    QDate disponibilite;
    QDate echeance;
protected: Tache(const QString& id, const QString& t, const TIME::Duree& dur, const QDate& dispo, const QDate& deadl, bool preempt=false):
...
class TacheU : private Tache , public Event
{
 ...
 public:
    ...
    TacheU(const QString& id, const QString& t, const TIME::Duree& dur, const QDate& dispo, const QDate& deadline, bool p=false):
...
public:
    TacheC(const QString& id, const QString& t, const TIME::Duree& dur, const QDate& dispo, const QDate& deadl): Tache(id,t,dur,dispo,deadl)
...
class VPrincipale // class abstraite pour le tableau de taches
{
  ...
  public:
    ...
    TacheU& ajouterTacheU(const QString& id, const QString& t, const TIME::Duree& dur, const QDate& dispo, const QDate& deadline, bool preempt=false);
